...
- возвращает агрегированную статистику и топ-20 худших пар.
"""
...
def batch_predict(
    ...
    return BatchPredictResponse(
        ...
        recall_at_50=float(np.mean(calibrated >= 0.50)),
        recall_at_70=float(np.mean(calibrated >= 0.70)),
        recall_at_90=float(np.mean(calibrated >= 0.90)),
