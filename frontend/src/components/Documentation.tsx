              ...
              <div className="space-y-4 font-sans text-sm text-slate-600 leading-relaxed">
                ...
                <div className="border-l-4 border-blue-100 pl-4 py-1">
                  ...
                  <p className="mt-1 text-xs">
                    Для эффективного обучения модели нужны примеры строк, которые визуально или лексически очень похожи, но описывают разные объекты (например, разные товары или бренды). 
